...
You should be in the `/home/<x-userid>` directory, where `<x-userid>` is replaced with your userid. This directory is where you will land by default when you first log in on the terminal. 
