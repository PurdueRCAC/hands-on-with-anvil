...
```bash
[userid@login1.frontier ~]$ cd ~/hands-on-with-anvil/challenges/Basic_Unix_Vim
```
...
```bash
[userid@login1.frontier ~]$ cd /ccs/home/<userid>/hands-on-with-anvil/challenges/Basic_Unix_Vim
```
...
```bash
[userid@login1.frontier Basic_Unix_Vim]$ cp /ccs/home/<userid>/hands-on-with-anvil/challenges/Basic_Unix_Vim/text_file.txt /ccs/home/<userid>/hands-on-with-anvil/challenges/Basic_Unix_Vim/mydirectory
```
